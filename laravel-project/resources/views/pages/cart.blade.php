                ...
                <div class="col-12 table-responsive">
                    <table class="table table-borderless table-cart">
                        ...
                        <tbody>
                            <tr>
                                <td style="width: 20%">
                                    <img src="/images/productcart1.jpg" alt="" class="cart-image" />
                                </td>
                                <td style="width: 35%">
                            ...
                            <tr>
                                <td style="width: 25%">
                                    <img src="/images/productcart2.jpg" alt="" class="cart-image" />
                                </td>
                                <td style="width: 35%">
                            ...
                            <tr>
                                <td style="width: 25%">
                                    <img src="/images/productcart3.jpg" alt="" class="cart-image" />
                                </td>
                                <td style="width: 35%">
