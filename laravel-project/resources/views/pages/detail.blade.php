            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2" data-aos="zoom-in">
                        <a href="/cart.html" class="btn btn-warning px-4 text-white btn-block mb-3">Add To Cart</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <ul class="list-unstyled">
                            <li class="media">
                                <img src="/images/testiicon1.png" alt="" class="mr-3 rounded-circle" />
                            ...
                            <li class="media">
                                <img src="/images/testiicon2.png" alt="" class="mr-3 rounded-circle" />
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img src="/images/testiicon3.png" alt="" class="mr-3 rounded-circle" />
                                <div class="media-body">
